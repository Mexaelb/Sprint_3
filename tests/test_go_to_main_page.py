...
def test_account_page_go_constuctor_button_constuctor(chrome_browser):
    ...
    WebDriverWait(chrome_browser, 5).until(expected_conditions.visibility_of_element_located((By.XPATH, all_locators.page_accont_button_save)))

    chrome_browser.find_element(By.XPATH, all_locators.page_account_button_constructor).click()
    WebDriverWait(chrome_browser, 5).until(expected_conditions.visibility_of_element_located((By.XPATH, all_locators.main_page_all_list)))
...
def test_account_page_go_constuctor_button_logo(chrome_browser):
    ...
    chrome_browser.find_element(By.XPATH, all_locators.page_account_button_logo).click()
    WebDriverWait(chrome_browser, 5).until(expected_conditions.visibility_of_element_located((By.XPATH, all_locators.main_page_all_list)))
